...
RcppExport SEXP _Rphenoannoy_jaccard_coeff_true_parallel(SEXP idxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type idx(idxSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Rphenoannoy_jaccard_coeff_true_parallel", (DL_FUNC) &_Rphenoannoy_jaccard_coeff_true_parallel, 1},
